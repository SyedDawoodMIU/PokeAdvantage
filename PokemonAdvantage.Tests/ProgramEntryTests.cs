...
namespace PokemonAdvantage.Tests
{
    public class ProgramEntryTests
    {
        ...
        public async Task RunAsync_PokemonNameIsEmpty_ThrowsException()
        {
            ...
            mockErrorHandler.Verify(e => e.HandleError(It.Is<Exception>(ex => ex.Message == "The Pokemon name is empty")), Times.Once);
        }
        ...
        public async Task RunAsync_FetchAndAdaptPokemonDataRetries()
        {
            ...
            // Assert
            mockApiManager.Verify(m => m.FetchPokemonData(It.IsAny<string>()), Times.Exactly(1));
        }
        ...
        public async Task RunAsync_FetchAndAdaptTypeDataRetries()
        {
            ...
            // Assert
            mockApiManager.Verify(m => m.FetchTypeRelationsAsync(It.IsAny<string>()), Times.Exactly(1));
        }
